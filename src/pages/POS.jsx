...
export default function POS() {
  ...
  return (
    <div >
      <h1 className="text-[19px] md:text-[22px] font-bold tracking-tight">Point of Sale <span className="text-xs font-bold text-white bg-red-500 px-2 py-0.5 rounded-full align-middle">BUILD v3</span></h1>
