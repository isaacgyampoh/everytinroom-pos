        ...
        <div className="bg-white rounded-2xl border-2 border-gray-100 overflow-hidden mb-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    <input
                      ...
                      min="1"
                    />
                    <span className="absolute -top-2 left-1/2 -translate-x-1/2 bg-green-500 text-white text-[9px] font-bold px-1.5 rounded-full">+ADD</span>
                  </div>
          ...
          <div className="bg-gray-50 px-5 py-4 border-t border-gray-100">
            ...
            <button
              ...
              className="w-full h-14 bg-green-500 hover:bg-green-600 disabled:bg-gray-300 text-white rounded-2xl text-base font-bold active:scale-[0.98] transition flex items-center justify-center gap-2"
            >
              {saving ? (
