      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-lg animate-fade">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input className="w-full h-13 px-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-base font-medium focus:outline-none focus:border-brand-500" placeholder="https://xxxxx.supabase.co" value={url} onChange={e => setUrl(e.target.value)} />
          </div>
          <div>
            <label className="block text-xs font-semibold text-gray-500 mb-2">Anon Key</label>
            <input className="w-full h-13 px-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-base font-medium focus:outline-none focus:border-brand-500" placeholder="eyJhbGciOiJIUzI1NiIs..." value={key} onChange={e => setKey(e.target.value)} />
          </div>
        </div>
