...
export default function Navigation({ onOpenCart }) {
  ...
  return (<>
    ...
    {/* Cart FAB */}
    {page === 'pos' && <button onClick={onOpenCart} className="fixed bottom-[calc(90px+env(safe-area-inset-bottom))] md:bottom-6 right-4 md:right-6 xl:hidden w-14 h-14 bg-[#f97316] rounded-2xl flex items-center justify-center text-white z-[99] shadow-lg shadow-orange-500/30 active:scale-90 transition hover:bg-[#ea580c]"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>{cc>0&&<span className="absolute -top-1.5 -right-1.5 min-w-[22px] h-[22px] bg-white text-[#f97316] rounded-full text-[11px] font-bold flex items-center justify-center shadow-md">{cc}</span>}</button>}
